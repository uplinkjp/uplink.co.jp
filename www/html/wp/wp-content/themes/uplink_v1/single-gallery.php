<?php get_header('gallery'); ?>
	...
	<!-- container str -->
	<div id="container" class="clearfix schedule individual gallery">
				<section class="data" style="background: #FFD3D4; margin: 100px 0; padding: 60px 30px;">
					...
					<a href="https://shibuya.uplink.co.jp/gallery/<?php the_time('Y'); ?>/<?php the_ID(); ?>" target="_blank">https://shibuya.uplink.co.jp/gallery/<?php the_time('Y'); ?>/<?php the_ID(); ?></a>
					</p>
				</section>
	</div>
	<!-- container end -->
