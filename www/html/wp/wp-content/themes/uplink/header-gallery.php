...
<?php if(is_single() or is_subpage() or is_tax()): //個別ページ・サブページ・カスタム分類を判別 ?>
	<title><?php wp_title('', true, 'right'); ?>- ギャラリー | <?php bloginfo('name'); ?></title>
	<meta property="og:title" content="<?php wp_title('', true, 'right'); ?>- ギャラリー | <?php bloginfo('name'); ?>" />
<?php else: ?>
...
<?php endif; ?>
	...
	<?php else: ?>
	<meta name="Description" content="渋谷アップリンクのギャラリー情報一覧" />
	<?php endif; ?>
	...
	<link rel="alternate" type="application/rss+xml" href="<?php echo get_post_type_archive_feed_link( 'gallery' ) ?>" />
